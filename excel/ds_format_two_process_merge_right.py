...
if __name__ == '__main__':
    ...
    p_cal_delta_loi = Process(target=p_clear_and_cal_delta_loi,args=())
    p_cal_demand_supply = Process(target=p_clear_and_cal_demand_supply,args=())
